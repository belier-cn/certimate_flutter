...
extension ContextExt on BuildContext {
  ...
  AppThemeData get appThemeData => theme.extension<AppThemeData>()!;

  S get s => S.maybeOf(this) ?? S.current;

  bool get isMaterialStyle => platform_widgets.isMaterial(this);

  bool get isCupertinoStyle => platform_widgets.isCupertino(this);
}
